    ...
    <div className="mx-auto max-w-2xl px-4 py-12 text-slate-700">
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed">
          ...
          data loss, trip disruptions, or reliance on information within the app. Use of this app 
          is at your own risk.
        </p>
      </section>
      ...
      <section className="mb-8">
        ...
        <p className="text-sm leading-relaxed">
          ...
          <a href="mailto:hello@wingspann.com" className="text-sky-500 hover:underline">
            hello@wingspann.com
          </a>
        </p>
      </section>
